...
import static com.example.sleep.psqi_managing.setq5_a_b_c;


public class psqi_survey_page3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_psqi_survey_page3);
        ...
        btn_next.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v){
                setq5_a_b_c(a_result,b_result,c_result);
                Intent intent = new Intent(getApplicationContext(),psqi_survey_page4.class);
                startActivity(intent);
            }
        });
    }
    public void onChecked_a(View v) {
    ...
    public void onChecked_b(View v){
        boolean checked = ((CheckBox) v).isChecked();
        switch (v.getId()){
    ...
    public void onChecked_c(View v){
        boolean checked = ((CheckBox) v).isChecked();
        switch (v.getId()){
